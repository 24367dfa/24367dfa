...
- [netz39/ansible-role-host-docker](https://github.com/netz39/ansible-role-host-docker) ([v0.6.3](https://github.com/netz39/ansible-role-host-docker/releases/tag/v0.6.3), 3 days ago) - Ansible Role for installing the Docker runtime environment on a (Debian) host.
