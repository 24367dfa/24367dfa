...
- [netz39/ansible-role-host-docker](https://github.com/netz39/ansible-role-host-docker) ([v0.6.4](https://github.com/netz39/ansible-role-host-docker/releases/tag/v0.6.4), 1 day ago) - Ansible Role for installing the Docker runtime environment on a (Debian) host.
