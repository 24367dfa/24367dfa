...
- [netz39/Netz39AmpelController](https://github.com/netz39/Netz39AmpelController) ([v0.2.0](https://github.com/netz39/Netz39AmpelController/releases/tag/v0.2.0), 2 months ago) - Microservice to provide the Controller for our Traffic Light and Space Status
...
- [:arrow_up: workflow: Update changelog generator action to use janhein…](https://github.com/netz39/ansible-role-host-docker/pull/15) on [netz39/ansible-role-host-docker](https://github.com/netz39/ansible-role-host-docker) (3 months ago)
