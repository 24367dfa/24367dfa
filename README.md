...
- [netz39/ansible-role-host-docker](https://github.com/netz39/ansible-role-host-docker) ([v0.6.1](https://github.com/netz39/ansible-role-host-docker/releases/tag/v0.6.1), today) - Ansible Role for installing the Docker runtime environment on a (Debian) host.
